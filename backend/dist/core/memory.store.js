...
class MemoryStore {
    constructor(vectorService, embeddingService) {
        ...
        Object.defineProperty(this, "memoryTool", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        this.memoryTool = new MemoryTool_1.MemoryTool(vectorService, embeddingService);
    }
    async initialize() {
        try {
...
Success: ${success}
    ...
    async getRelatedExperiences(context, limit = 5) {
        this.ensureInitialized();
    ...
    async getSimilarResearch(query, limit = 5) {
        this.ensureInitialized();
    ...
    async getConversationHistory(query, limit = 10) {
        this.ensureInitialized();
        return await this.searchMemories(query, {
            limit,
            threshold: 0.5,
    ...
    async getSuccessfulExperiences(context, limit = 5) {
        this.ensureInitialized();
    ...
    async getFailedExperiences(context, limit = 5) {
        this.ensureInitialized();
        const experiences = await this.searchMemories(context, {
            limit: limit * 2,
            threshold: 0.6,
    ...
    async generateMemorySummary(query) {
        this.ensureInitialized();
    ...
    async clearOldMemories(maxAge = 90) {
        this.ensureInitialized();
